...
public partial class Logger : Node
{
	...
	/// <summary>
	/// Exposing a buffer log for Mr. Steiner ;)
	/// </summary>
	public StringBufferLog strLog;
	...
	Logger()
	{
		this.strLog = new StringBufferLog("default", new StringWriter(), LogLevel.Trace);
		this.AddProvider(this.strLog);
	}
	...
	private void Log(string message, LogLevel level)
	{
		...
		var isMainThread = System.Environment.CurrentManagedThreadId == _mainThreadId;
		var threadName = Thread.CurrentThread.Name ?? System.Environment.CurrentManagedThreadId.ToString("x8");
